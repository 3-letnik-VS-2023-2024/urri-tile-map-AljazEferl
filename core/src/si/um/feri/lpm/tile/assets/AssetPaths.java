...
public class AssetPaths {
    ...
    public static final String TILES = "tiles/mower.tmx";
    ...
    public static final String MOWER_START_MUSIC = "sounds/mowerstart.mp3";
    public static final String MOWER_END_MUSIC = "sounds/mowerstop.mp3";
    public static final String MOWER_LOOP_MUSIC = "sounds/mowerloop.mp3";
